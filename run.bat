...
timeout /t 5 /nobreak
cd C:\Users\py\Documents\GitHub\EyeOfBeholder && start powershell -Command  while ($true) {daphne -e "ssl:8001:privateKey=myselfsigned.key:certKey=myselfsigned.cer" vef.asgi:application}
timeout /t 7 /nobreak
